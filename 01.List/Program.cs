...
namespace _01.List
{
    internal class Program
    {
        ...
        static void Main111(string[] args)
        {
            ...
            // 중간추가
            list.Insert(1, "중간 데이터1에 추가");
            list.Insert(3, "중간 데이터3에 추가");

            // 삭제
            // Remove의 반환형은 bool이다
            list.Remove("2번째 데이터");                 // 삭제 시 위치는 앞으로 당겨진다
            list.Remove("3번째 데이터");                 // 빈자리는 용납하지 않음
            list.RemoveAt(2);                           // 2번 인덱스에 있는 것을 삭제함

            list.Remove("6번째 데이터");                 // 해당 데이터가 없으면 그냥 패스한다
