    ...
    internal class Program
    {
        ...
        ***********************************************************************************/
        ...
        static void Main111(string[] args)
        {
            ...
            LinkedListNode<string> node1 = linkedList.AddFirst("1번 데이터");            // 앞에 추가

            LinkedListNode<string> node2 = linkedList.AddLast("2번 데이터");
            LinkedListNode<string> node3 = linkedList.AddLast("3번 데이터");            // 뒤에 추가


            LinkedListNode<string> node4 = linkedList.AddBefore(node0, "0번 앞에 넣는 데이터");
            LinkedListNode<string> node5 = linkedList.AddAfter(node0, "0번 뒤에 넣는 데이터");    // 중간에 추가
            ...
            // 접근
            LinkedListNode<string> firstNode = linkedList.First;        // 첫번째노드
            LinkedListNode<string> lastNode = linkedList.Last;          // 마지막노드
            LinkedListNode<string> prevNode = node0.Previous;           // 특정 노드를 기준으로 이전 노드
            LinkedListNode<string> nextNode = node0.Next;               // 특정 노드를 기준으로 다음 노드
